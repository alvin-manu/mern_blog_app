      ...
      <div className="mb-8">
        ...
        {blogs.length > 0 ? (
          ...
          <div className="text-center py-12 bg-white rounded-xl shadow-sm">
            ...
            <h3 className="text-lg font-medium text-gray-600 mb-2">No articles published yet</h3>
            <p className="text-gray-500">When {user.name} writes articles, they'll appear here.</p>
          </div>
        )}
      </div>
    </div>
